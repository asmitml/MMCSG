...
def preprocess_dataset(dataset):
    ...
    # print(dataset["personality_features"].shape)
    model_inputs['personality_input'] = torch.tensor(dataset["personality_features"]).to(DEVICE)
...
def get_scores(reference_list: list,
    ...
    for reference, hypothesis in list(zip(reference_list, hypothesis_list)):
        ...
        # bertscore += Bertscore(reference,hypothesis)["f1"]
...
def get_val_scores(model,
    ...
    if "Validation" in desc:
        ...
        file_name = RESULT_OUTPUT_DIR + "val/pc" + str(epoch+1) + "_val_results.csv"
        ...
        file_name = RESULT_OUTPUT_DIR + "test/pc" + str(epoch+1) + "_test_results.csv"
...
def train(model,
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        print("\nval_rouge_1: {}\tval_rouge_2: {}\tval_rouge_L: {}\tval_bleu_1: {}\tval_bleu_2: {}\tval_bleu_3: {}\tval_bleu_4: {}\tval_meteor: {}\tval_bert_score: {}".format(
        val_results['rouge_1'], val_results['rouge_2'], val_results['rouge_L'], val_results['bleu_1'], val_results['bleu_2'], val_results['bleu_3'], val_results['bleu_4'], val_results['meteor'], val_results['bertscore']))
        
        print("\ntest_rouge_1: {}\ttest_rouge_2: {}\ttest_rouge_L: {}\ttest_bleu_1: {}\ttest_bleu_2: {}\ttest_bleu_3: {}\ttest_bleu_4: {}\ttest_meteor: {}\test_bertscore: {}".format(
        test_results['rouge_1'], test_results['rouge_2'], test_results['rouge_L'], test_results['bleu_1'], test_results['bleu_2'], test_results['bleu_3'], test_results['bleu_4'], test_results['meteor'], test_results['bertscore']))
